...
<body>
    ...
    <main>
        <div><h1 style="color:orange;">UPDATE YOUR PRODUCT</h1></div>
        <Form action="Update" method="post">
        	<input name="id" value="${id}" style="display:none;">
            <label for="productname" class="form-label">Product Name</label>
            <input name="Pname" type="text" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
            <label for="image" class="form-label">Image(URL)</label>
            <input name="Pimg" type="text" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
            <label for="price" class="form-label">Price</label>
            <input name="Pprice" type="number" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
            <div class="mb-3">
                <label for="disabledSelect" class="form-label">Discount</label>
                <select name="Pdiscount" id="disabledSelect" class="form-select">
                  <option>60</option>
                  <option>50</option>
                  <option>40</option>
                  <option>30</option>
